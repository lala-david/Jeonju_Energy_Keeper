...
# data
df = pd.read_json('src/json/ironMan6.json')

# dic
data_dict = df.set_index('행정동')['태양광설비수'].to_dict()
...
min_sunshine = df['태양광설비수'].min()
max_sunshine = df['태양광설비수'].max()
